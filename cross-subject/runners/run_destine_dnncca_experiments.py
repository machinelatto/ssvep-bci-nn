"""
Run DESTINE DNN+CCA cross-subject experiments via CLI.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run DESTINE DNN+CCA cross-subject experiments")
    parser.add_argument(
        "--dataset-path",
        type=str,
    ...
    parser.add_argument(
        "--results-dir",
        type=str,
        default="destine_results/dnncca",
    )
...
def main():
    ...
    print("\nAll DESTINE DNN+CCA experiments completed.")
