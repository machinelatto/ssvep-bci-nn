"""
Run EEGNet for all users using CCA-projected tensors as input.
"""
...
for tamanho_da_janela_seg_val in tamanho_da_janela_seg:
    ...
    exp_dir = Path(
        "/home/mateuschinelatto/Experiments/ssvep-bci-nn/cross-subject/louo_experiments/models/eegnetcca_10"
    )
