"""
Run DESTINE DNN cross-subject experiments (no CCA projection) via CLI.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run DESTINE DNN cross-subject experiments")
    parser.add_argument(
        "--dataset-path",
        type=str,
...
def main():
    ...
    print("\nAll DESTINE DNN experiments completed.")
