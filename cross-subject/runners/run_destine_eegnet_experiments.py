"""
Run DESTINE EEGNet cross-subject experiments (no CCA projection) via CLI.
...
from destine_dataset import build_tensors_no_cca, load_data_from_users
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run DESTINE EEGNet cross-subject experiments")
    parser.add_argument(
        "--dataset-path",
        type=str,
    ...
    parser.add_argument("--weight-decay", type=float, default=6.8e-4)
    ...
    parser.add_argument("--freq-cut-low", type=float, default=5.0)
    ...
    parser.add_argument(
        "--results-dir",
        type=str,
        default="destine_results/eegnet",
    )
...
def main():
    ...
    for test_user in test_users:
        ...
        x_train, x_test, labels_train, labels_test, channels_for_model = build_tensors_no_cca(
    ...
    print("\nAll DESTINE EEGNet experiments completed.")
